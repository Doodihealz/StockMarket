...
-- Dumping data for table acore_world.stockmarket_events: ~143 rows (approximately)
INSERT INTO `stockmarket_events` (`id`, `event_text`, `percent_change`, `is_positive`, `rarity`) VALUES
	...
	(137, 'Thrall\'s trousers discovered outside Jaina\'s apartment. Horde in chaos.', -4.50, 0, 4),
	(138, 'Wilfred Fizzlebangs business flops after his death.', -0.66, 0, 2),
	(139, 'Cairne Bloodhoof donates to Northrend Expeditionary forces.', 1.11, 1, 1),
	(140, 'Investments pour into the Cut Gem market!', 1.20, 1, 1),
	(141, 'An Extremely cool player is using this script! The citizens of Azeroth celebrate!', 2.30, 1, 2),
	(142, 'Taxes from Dungeonfinder double in recent report.', 1.30, 1, 1),
	(143, 'Ashenvale logs selling for triple typical market value. Logging companies profits soar!', 1.70, 1, 1),
	(144, 'Leather prices plummet as Rogue nerf announced.', -0.60, 0, 1),
	(145, 'Gold sellers causing rampant inflation.', -1.50, 0, 1),
	(146, 'Mayonaise categorized as an instrument!', 0.30, 1, 1);
